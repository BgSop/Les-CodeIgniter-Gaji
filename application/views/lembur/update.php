        ...
        <div class="page-wrapper">
            ...
            <div class="card mt-3">
                <div class="card-body mb-5">
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <form action="<?php echo site_url('pengguna/prosesUpdate') ?>" class="form-horizontal" method="POST">
                                <div class="form-group row">
                                    <label class="col-sm-3 text-right control-label col-form-label">Username</label>
                                    <div class="col-sm-9">
                                        <input name="id" value="<?php echo $pengguna->pengguna_id ?>" type="hidden">
                                        <input value="<?php echo $pengguna->pengguna_username ?>" type="text" class="form-control" name="username" placeholder="Username">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 text-right control-label col-form-label">Password</label>
                                    <div class="col-sm-9">
                                        <input value="<?php echo $pengguna->pengguna_password ?>" type="text" class="form-control" name="password" placeholder="Password">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-3 text-right control-label col-form-label">Nama</label>
                                    <div class="col-sm-9">
                                        <input value="<?php echo $pengguna->pengguna_nama ?>" type="text" class="form-control" name="nama" placeholder="Nama">
                                    </div>
                                </div>
                                <div class="form-group row">

        ...
        <div class="page-wrapper">
            ...
            <div class="card mt-3">
                <div class="card-body mb-5">
                    <h4 class="card-title mb-3">Tambah Data Jabatan</h4>
                    <a href="<?php echo site_url('jataban') ?>" class="btn btn-success mb-3">Kembali</a>
                    <div class="row">
                        <div class="col-md-8">
                            <form action="<?php echo site_url('jabatan/add') ?>" class="form-horizontal" method="POST">
                                <div class="form-group row">
                                    <label class="col-sm-3 text-right control-label col-form-label">Kode Jabatan</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="kode" placeholder="Kode Jabatan">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" class="form-control" name="gapok" placeholder="Gaji Pokok">
                                    </div>
                                </div>
                                <div class="form-group row">
